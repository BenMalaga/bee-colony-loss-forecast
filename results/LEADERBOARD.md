...
**Reference floor.** The bar is the *recalibrated* seasonal-naive, not raw naive — anything above
...
|---|---|---|---|---|---|
| — | seasonal-naive | loss_{t−4} | 1.000 | — | baseline (denominator) |
| — | persistence | loss_{t−1} | 1.230 | [1.12, 1.35] | worse — loss is seasonal |
| — | climatological mean | state×qtr train mean | 1.003 | [0.90, 1.13] | ties naive |
...
| — | HGB, loss + **stressors** | + 6 stressor lags | 0.934 | [0.84, 1.04] | stressors add nothing |
| — | Ridge, loss + stressors | + 6 stressor lags | 0.945 | [0.88, 1.03] | — |
...
already contain** — in particular, show any stressor/covariate set that adds detectable value.
